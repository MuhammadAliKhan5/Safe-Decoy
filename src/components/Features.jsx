...
const FeatureCard = ({ icon: Icon, title, desc }) => (
  <div className="
    ...
    hover:border-[#bd3c1b] 
    hover:-translate-y-3
    /* This creates the heavy, broad red glow */
    hover:shadow-[0_0_60px_-10px_rgba(189,60,27,0.8)]
  ">
    <Icon className="w-12 h-12 text-[#bd3c1b] mb-6 group-hover:drop-shadow-[0_0_10px_rgba(189,60,27,0.8)]" />
